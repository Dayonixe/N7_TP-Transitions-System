...
bouger(nbM,nbC) ==
    ...
    /\ nbM+nbC >= 1
    /\ IF barque="G" THEN
            (inv(barque) /\ riveG.missionnaire - nbM /\ riveG.cannibale - nbC /\ riveD.missionnaire + nbM /\ riveD.cannibale + nbC)
        ELSE
            (inv(barque) /\ riveD.missionnaire - nbM /\ riveD.cannibale - nbC /\ riveG.missionnaire + nbM /\ riveG.cannibale + nbC)
    /\ pasMiam'
...
\* Last modified Thu May 05 11:55:20 CEST 2022 by theo
