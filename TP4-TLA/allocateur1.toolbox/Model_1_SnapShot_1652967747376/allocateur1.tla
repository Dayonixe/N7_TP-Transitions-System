...
(* Version concrÃ¨te de l'allocation de ressources. *)
...
(* XXXX Autres propriÃ©tÃ©s temporelles de sÃ»retÃ© *)
(* Pas de demande de 0 ressource satisfaite *)
ZeroPasSatisfait == [](\A i \in 0..N-1 : demande[i] = 0 => ~satisfait[i])

(* Somme des demandes satisfaites <= nbDispo *)
SatisfaitesSontDispos == [](LET process == { i \in 0..N-1 : satisfait[i] } IN SommeDemande[process] = M - nbDispo)

(* XXXX Autres propriÃ©tÃ©s temporelles de vivacitÃ© *)
...
Fairness == \A i \in 0..N-1 : WF_<<demande,satisfait,nbDispo>> (obtenir(i))
